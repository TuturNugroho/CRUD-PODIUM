...
<body>
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="../layout/icon/podium-putih.png" alt="" />
            </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <div id="sidebar">
                    ...
                    <ul class="nav navbar-nav side-bar">
                        <li class="side-bar tmargin"><a href="../layout/dashboard-admin.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
                        ...
                        <li class="side-bar"><a href="pages.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
            ...
            <div class="col-sm-9">
                <div class="input">
                    <form action="../prosesdata.php?aksi=tambah-artikel" method="post">
                        <div class="mb-3">
                            <h1>Artikel </h1>

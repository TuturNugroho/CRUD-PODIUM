        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div id="sidebar">
                    ...
                    <ul class="nav navbar-nav side-bar">
                        <li class="side-bar tmargin"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
            ...
            <div class="col-sm-9">
                <div class="container">
                    ...
                    <button type="button" class="btn btn-secondary"><a class="input" href="tambah-data.php">Tambah Data</a></button>
                </div>
                <div class="container ">
